...
if __name__ == '__main__':
    app.run(debug=True)`}
                ...
                <div className="space-y-8">
                  ...
                  <div className="mb-8">
                    <p className="text-gray-300 text-lg leading-relaxed">
                      Learn how to set up and use DocumentDB with Node.js using
                  ...
                  <div className="bg-neutral-800/50 backdrop-blur-sm rounded-lg border border-neutral-700/50 p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                      Before connecting from Node.js, make sure you have a
                      running DocumentDB instance using Docker:
                    </p>
...
docker image rm -f ghcr.io/microsoft/documentdb/documentdb-local:latest || echo "No existing documentdb image to remove"`}
                    ...
                    <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4">
                      <p className="text-blue-200 text-sm">
                        ...
                        (the standard MongoDB port) or any other available port
                        if you prefer. If you do, be sure to update the port
                        number in both your{" "}
                        <code className="bg-blue-900/30 px-1 rounded">
                          docker run
                        </code>{" "}
